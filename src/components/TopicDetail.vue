  ...
  <div class="topicdetail">
      <main>
          <section class="topic-content">
              <div class="user-info">
                  <div class="user-avatar"><v-gravatar email="835614574@qq.com" size='40' /></div>
          ...
          <section class="comment">
              <div class="comment-head">
                  <div class="comment-count">评论<span>( 10 )</span></div>
              ...
              <section class="user-comment">
                  <ul class="comment-list">
                      <li>
                          ...
                          <el-row :gutter="10">
                            <el-col :xs="3" :sm="2" :md="2" :lg="2" :xl="2"><div class="grid-content">
                                <div class="user-avatar"><v-gravatar email="835614594@qq.com" size='40' align="right" /></div>
                                </div></el-col>
                            <el-col :xs="21" :sm="22" :md="22" :lg="22" :xl="22"><div class="grid-content">
                          ...
                          <el-row :gutter="10" class="replyTo">
                            <el-col :xs="3" :sm="2" :md="2" :lg="2" :xl="2"><div class="grid-content bg-purple">
                                <div class="user-avatar"><v-gravatar email="8356145945@qq.com" size='40'  align="right" /></div>
                                </div></el-col>
                            <el-col :xs="21" :sm="22" :md="22" :lg="22" :xl="22"><div class="grid-content bg-purple">
                                <div>
                                <div class="meta">
                                    <router-link :to="{ name: 'like', params: { uName: userName }}"> jesses</router-link>
                                    <span class="separator">• </span>
